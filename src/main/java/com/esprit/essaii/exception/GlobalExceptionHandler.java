...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> ressourceDuplicated( RessourceDuplicated ex, WebRequest request){
		/* votre description de l'exception déclanchée */
		ErrorDetails rep = new ErrorDetails(new Date(), ex.getMessage(),
				request.getDescription(false));
		
		return new ResponseEntity<>(rep,HttpStatus.FOUND);
